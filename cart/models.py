...
class OrderInfo(models.Model):
    ...
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, verbose_name="订单用户")
...
class OrderGoods(models.Model):
    goods = models.ForeignKey(GoodsInfo, on_delete=models.CASCADE, verbose_name='所属商品')
